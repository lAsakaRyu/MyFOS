...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //staffName.setText(InstanceDataHolder.getInstance().get_Staff().get_Name());
        setTitle(getString(R.string.title_activity_main)+" "+InstanceDataHolder.getInstance().get_Staff().get_Name());
